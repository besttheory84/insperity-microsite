...
<head id="page_title" runat="server">
	...
	<link href="/Templates/ion/Microsite/Themes/page-three/theme.css" rel="stylesheet" type="text/css">
    <link href="../commonResponsive.css" rel="stylesheet" type="text/css">
    <link href="/Templates/ion/Microsite/Themes/page-three/themeResponsive.css" rel="stylesheet" type="text/css">
	<link href="../animate.min.css" rel="stylesheet" type="text/css">
	
    <!--[if lt IE 9]>
    <link href="/Templates/ion/Microsite/Themes/page-three/ie.css" rel="stylesheet" type="text/css" />
...
<body id="page_body" friendlyname="Body" runat="server">
	...
	<div id="container">
        ...
        <div id="main-content">
			<article class="articleclearfix" role="main">
				<section class="left-side">
					<div id="headline1" class="headline" runat="server"></div>
                    <div id="text1" class="text" runat="server"></div>
              	</section>
                <section class="right-side">
                	<div class="module">
                        <div class="form-holder">
                            <div id="title6" class="title" runat="server"></div>
        ...
        <!-- end main-content -->
        <div class="content">
        	<div id="headline2" class="headlineSEM" runat="server"></div>
            <div id="subhead" class="subhead" runat="server"></div>
        	<article class="article_content clearfix" role="main">
                <div class="contentbox"> 
                	<div class="two-column clearfix">
                    	<div id="column1" class="column">
                            <div class="feature">
                            	<div class="feature-icon">
                                	<div id="icon1" runat="server"></div>
                                </div>
                                <div class="feature-text">
                                    <div id="feature_title1" class="feature-title" runat="server"></div>
                            ...
                            <div class="feature">
                            	<div class="feature-icon">
                                	<div id="icon2" runat="server"></div>
                                </div>
                                <div class="feature-text">
                                    <div id="feature_title2" class="feature-title" runat="server"></div>
                            ...
                            <div class="feature">
                            	<div class="feature-icon">
                                	<div id="icon3" runat="server"></div>
                                </div>
                                <div class="feature-text">
                                    <div id="feature_title3" class="feature-title" runat="server"></div>
                                    <section id="section3" runat="server"></section>
                             	</div>
                            </div>
                        	<!-- end feature -->
                            <div class="feature">
                            	<div class="feature-icon">
                                	<div id="icon4" runat="server"></div>
                                </div>
                                <div class="feature-text">
                                    <div id="feature_title4" class="feature-title" runat="server"></div>
                                    <section id="section4" runat="server"></section>
                               	</div>
                            </div>
                        	<!-- end feature -->
                            <div class="feature">
                            	<div class="feature-icon">
                                	<div id="icon5" runat="server"></div>
                                </div>
                                <div class="feature-text">
                                    <div id="feature_title5" class="feature-title" runat="server"></div>
                                    <section id="section5" runat="server"></section>
                               	</div>
                            </div>
                        	<!-- end feature -->
                		</div> 
                        ...
                        <div id="column2" class="column">
							<div id="computer_img" class="computer-img" runat="server"></div>
                        </div> 
                        <!-- end column2 -->
                	</div> 
                	<!-- end two-column -->
        ...
        <div class="table-area">
        	<div id="headline3" class="headlineSEM" runat="server"></div>
            <section id="subhead2" class="subhead" runat="server"></section>
            <div id="table" class="table" runat="server"></div>
            <!-- end table -->    
       	</div>
        <!-- end table-area -->
            
        <div class="demo-box">
            <div id="demo_text" class="demo-text" runat="server"></div>
            <div class="demo-link">
                <div id="demo_link" runat="server"></div>
            </div>
            <div class="clearfix"></div>
        </div>
        <!-- end demo-box -->  
        ...
        <div class="wo-area">
        	<div id="wo_title" class="title" runat="server"></div>
            <div id="text2" class="text" runat="server"></div>
            <div class="left-list list">
            	<div id="left_list" runat="server"></div>
            </div>
            <!-- end left-list -->
            <div class="right-list list">
            	<div id="right_list" runat="server"></div>
            </div>
            <!-- end right-list -->
            <div class="clearfix"></div>
        </div>
        ...
        <div class="solutions-box clearfix">
            <div class="solutions-header clearfix">
                <div id="solutions-header-box">
                    <div id="solutions_title" class="solutions-title" runat="server"></div>
                    <div id="solutions_sub" class="solutions-sub" runat="server"></div>
                </div>
                <div id="learnmore">
                    <div id="learn_text" class="learn-text" runat="server"></div>
                    <div id="learnmorebutton" runat="server"></div>
                </div>
                <div class="clearfix"></div>
            </div>
            <!-- end solutions-header -->
            <div id="icon_minefield" class="clearfix" runat="server"></div>
            <!-- end icon-minefield -->
        </div>
        <!-- end solutions-box -->
        <div class="clearfix"></div>
