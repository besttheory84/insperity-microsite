$(document).ready(function() {
	...
	$('.right-side input[type=submit]').val('I want to know more');
	$('.submitbutton').append('<div class="arrow-left"></div>').children('.clearfix, .iconarrow').remove();
	...
	$(function() {
		$( "#slider" ).slider({
			change: function( event, ui ) {		
				...
				var optIn = (members*percentage);
				var firstAmount = (optIn*5000);
				var newAmount = (firstAmount*0.08);
